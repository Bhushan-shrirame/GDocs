...
const ImageButton = () => {
  ...
  const [imagelUrl, setImangeUrl] = useState("");
  ...
  const onUpload = () => {
    ...
    input.onchange = (e) => {
      ...
      if (file) {
        const imagelUrl = URL.createObjectURL(file);
        onChange(imagelUrl);
      }
    };
    input.click();
...
const HeadingLevelButton = () => {
  ...
  const heading = [
    ...
    { label: "Headin 1", value: 1, fontSize: "32px" },
    { label: "Headin 2", value: 2, fontSize: "24px" },
    { label: "Headin 3", value: 3, fontSize: "20px" },
    { label: "Headin 4", value: 4, fontSize: "18px" },
    { label: "Headin 5", value: 5, fontSize: "16px" },
  ];
...
const FontFamilyButton = () => {
  ...
  const fonts = [
    ...
    { label: "Times New Roman", value: "Time New Roman" },
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button className="h-7 w-[120px] shrink-0 flex items-center justify-between rounded-sm hover:bf-neutral-200/80 px-1.5 overflow-hidden text-sm">
